...
/*   Updated: 2021/11/29 13:37:44 by eassouli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
pid_t	create_child_builtin(char **arg, char ***env, t_callback f_builtin
	, t_cmd *cmd)
{
	pid_t	pid;
...
int	exec_builtin(int builtin, char ***env, t_cmd *cmd)
{
	...
	{
		cmd->pid = create_child_builtin(cmd->argv, env,
				f_builtin[builtin], cmd);
